...
@pytest.mark.parametrize(
    ...
    [
        ('fiducial_history_length', 0),
        ('fiducial_history_length', -1),
        ('fiducial_history_length', 33),
        ('fiducial_history_length', True),
        ('fiducial_history_length', 1.0),
        ('fiducial_tracking_rate_hz', 0.9),
        ('fiducial_tracking_rate_hz', 60.1),
        ('fiducial_tracking_rate_hz', math.nan),
        ('fiducial_tracking_rate_hz', math.inf),
        ('fiducial_tracking_rate_hz', True),
        ('fiducial_tracking_rate_hz', '30'),
        ('fiducial_grace_period_seconds', 0),
        ('fiducial_grace_period_seconds', 0.09),
        ('fiducial_grace_period_seconds', 60.1),
        ('fiducial_grace_period_seconds', math.nan),
        ('fiducial_grace_period_seconds', math.inf),
        ('fiducial_grace_period_seconds', True),
        ('fiducial_protection_margin_mm', 0),
        ('fiducial_protection_margin_mm', 0.09),
        ('fiducial_protection_margin_mm', 1000.1),
        ('fiducial_protection_margin_mm', math.nan),
        ('fiducial_protection_margin_mm', math.inf),
        ('fiducial_protection_margin_mm', True),
        ('max_batch_operations', 0),
        ('max_batch_operations', -1),
        ('max_batch_operations', 1001),
        ('max_batch_operations', True),
        ('max_batch_operations', 1.0),
        ('preview_mode', 'normal'),
        ('preview_mode', ''),
        ('preview_mode', None),
        ('preview_mode', 1),
        ('preview_low_rate_hz', 0.9),
        ('preview_low_rate_hz', 15.1),
        ('preview_low_rate_hz', math.nan),
        ('preview_low_rate_hz', math.inf),
        ('preview_low_rate_hz', True),
        ('preview_low_rate_hz', '10'),
    ],
)
